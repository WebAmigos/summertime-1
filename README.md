...
- website - add validation and revalidation to reviews form
- frontend - add UI where you can activate review
- backend - add config, swagger, validation, serialization and restrict cors for website and frontend
